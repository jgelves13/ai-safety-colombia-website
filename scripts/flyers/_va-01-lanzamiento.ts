...
export default async function (format: FlyerFormat = 'portrait') {
    ...
    <div style="display:flex;width:${W}px;height:${H}px;background:${BRAND.cream};font-family:Inter;position:relative;overflow:hidden">
      ...
      <div style="display:flex;flex-direction:column;width:${W}px;height:${H}px;padding:${padT}px 80px ${padB}px 80px;justify-content:space-between">
        ...
        <div style="display:flex;flex-direction:column;max-width:820px">
          <div style="display:flex;font-family:JetBrains Mono;font-size:${kickerSz}px;letter-spacing:0.18em;color:${CORAL};text-transform:uppercase;margin-bottom:14px">Hub Bogotá · postúlate hasta el 12 jun 2026</div>
          ...
          <div style="display:flex;font-family:Inter;font-weight:500;font-size:${subSz}px;line-height:1.4;color:${BRAND.ink2};max-width:760px;margin-top:${bodyGap}px">Tres días para hacer investigación técnica y política de seguridad de IA, junto a equipos de toda la región.</div>
        </div>
        ...
        <div style="display:flex;flex-direction:column;gap:8px">
          ...
          <div style="display:flex;font-family:Inter;font-weight:600;font-size:24px;color:#0C0C0C">Sede presencial en Bogotá · participación remota desde el Sur Global</div>
        </div>

        <div style="display:flex;align-items:center;height:${chipH}px;padding:0 ${chipPad}px;background:${MINT};border-radius:9999px;font-family:Bricolage Grotesque;font-weight:700;font-size:${chipFs}px;color:${BRAND.forest};align-self:flex-start">Premio USD 3.000 · 3 equipos ganadores LATAM</div>
        ...
        <div style="display:flex;align-items:flex-end;justify-content:space-between">
          <div style="display:flex;flex-direction:column;align-items:center;gap:12px">
            ...
            <div style="display:flex;font-family:JetBrains Mono;font-size:14px;letter-spacing:0.2em;color:${BRAND.forest};text-transform:uppercase">Postulación abierta</div>
          </div>
  ...
  return { filename: `_va-01-lanzamiento-${format}.png`, png };
}
