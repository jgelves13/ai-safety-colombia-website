...
export default async function (format: FlyerFormat = 'portrait') {
      ...
      <div style="display:flex;flex-direction:column;width:${W}px;height:${H}px;padding:${padT}px 80px ${padB}px 80px;justify-content:space-between">
        ...
        <div style="display:flex;align-items:flex-start;justify-content:space-between;gap:48px">
          ...
          <div style="display:flex;flex-direction:column;gap:36px;flex:1">
            <div style="display:flex;font-family:Inter;font-weight:500;font-size:${leadSz}px;line-height:1.4;color:#0C0C0C;max-width:600px">El cupo para sede presencial en Bogotá cierra el</div>
            ...
            <div style="display:flex;font-family:Inter;font-weight:500;font-size:${bodySz}px;line-height:1.5;color:#0C0C0C;max-width:600px">Participación sin costo. Workspace abierto las 24 horas, alimentación incluida, mentoría y charlas en vivo durante los tres días.</div>
          </div>
  ...
  return { filename: `_va-07-cierre-${format}.png`, png };
}
