      ...
      <section className={HERO_SECTION}>
        ...
        <div className="mx-auto w-full max-w-[1448px] px-8 md:px-16 relative z-10 flex min-h-[380px] flex-col justify-end pt-28 pb-12 md:min-h-[430px] md:pt-32 md:pb-16">
          ...
          <div className="flex w-full flex-col gap-5">
            <h1 className="text-display-1 md:text-display-1-lg text-sash-frost break-words">{post.title}</h1>
            <p className="text-body md:text-body-lg max-w-[660px] text-sash-frost">{post.description}</p>
            <p className="text-meta md:text-meta-lg text-sash-frost">{post.dateLabel}</p>
          </div>
        </div>
      </section>
