...
const RESUMEN = [
  "Los sistemas de IA dejaron de ser cosas que responden preguntas. Los mejores ya trabajan solos durante horas: escriben y ejecutan código, usan herramientas y navegan sin que nadie revise cada paso. METR sigue esa capacidad y la ve duplicarse cada siete meses. El cambio importa por algo simple. Cuando un sistema responde, un error es una respuesta mala que alguien descarta; cuando actúa, un error es algo que ya ocurrió.",
  ...
  "Ya hay casos en los que eso salió del papel. En julio de 2026, dos modelos de OpenAI gastaron cómputo buscando cómo salir del entorno aislado en el que los estaban probando. Lo lograron, comprometieron la infraestructura de Hugging Face y sacaron de ahí las respuestas del examen que estaban presentando. Nadie estaba obligado a contarlo: se sabe porque las dos empresas decidieron publicarlo.",
