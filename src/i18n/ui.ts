export const ui = {
  es: {
    ...
    'events.legendTitle': 'Sobre los formatos',
    'events.type.charlaDesc': 'Una persona expone un tema y luego responde preguntas.',
    'events.type.panelDesc': 'Varios invitados discuten un tema, guiados por un moderador.',
    'events.type.conversatorioDesc': 'Diálogo abierto e informal entre invitados y asistentes.',
    'events.type.cenaDesc': 'Encuentro alrededor de una cena para conversar y crear comunidad.',
    'events.type.tallerDesc': 'Sesión práctica, con ejercicios y trabajo en grupo.',
    'events.type.cursoDesc': 'Programa de varias sesiones para aprender un tema a fondo.',
  ...
  en: {
    ...
    'events.legendTitle': 'About the formats',
    'events.type.charlaDesc': 'One speaker presents a topic, then takes questions.',
    'events.type.panelDesc': 'Several guests discuss a topic, guided by a moderator.',
    'events.type.conversatorioDesc': 'An open, informal dialogue between guests and attendees.',
    'events.type.cenaDesc': 'A dinner gathering to talk and build community.',
    'events.type.tallerDesc': 'A hands-on session, with exercises and group work.',
    'events.type.cursoDesc': 'A multi-session program to learn a topic in depth.',
