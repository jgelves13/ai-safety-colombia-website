...
export function renderInterestConfirmation(
  ...
  const t = es
    ? {
        ...
        step2: 'Si quieres empezar ya, puedes tomar las lecturas directamente en BlueDot Impact. Nuestra diferencia es que las facilitamos en español y, con demanda suficiente, en persona en Bogotá.',
    ...
    : {
        ...
        step2: 'If you want to start right away, you can take the readings directly with BlueDot Impact. The difference with us is that we facilitate them in Spanish and, with enough demand, in person in Bogotá.',
