...
const PATTERN = "/sash/patterns/sash-pattern-2.svg";
      ...
      <div className="mx-auto w-full max-w-[1400px] py-12 md:py-14 lg:py-16">
        <div className={CTA_PANEL}>
          ...
          <div className="relative z-10 flex w-full max-w-[760px] flex-col items-center gap-6">
            <h2 className="text-display-2 md:text-display-2-lg max-w-[760px] text-balance text-sash-frost">{title}</h2>
            <p className="text-body md:text-body-lg max-w-[760px] text-sash-frost">{body}</p>
