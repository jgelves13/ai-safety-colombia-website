...
import { type Idioma, menu } from "@/lib/idiomas";

const WHATSAPP = "https://chat.whatsapp.com/KwE8cciX48TAVhAOHnrLaZ";

/* Las mismas seis entradas del encabezado, en el mismo orden y del mismo
   archivo. Programas, Eventos y Actualidad no están en el menú, así que
   tampoco acá. */

/* Lo poco que el pie dice por su cuenta, en los tres idiomas. */
const TEXTOS: Record<Idioma, {
  ...
  es: {
    lema: "Hacia una inteligencia artificial segura, desde Colombia.",
    whatsapp: "Únete al WhatsApp",
    navegacion: "Navegación",
    comunidad: "Comunidad",
    secciones: "Secciones del sitio",
    contacto: "Comunidad y contacto",
    whatsappRed: "Comunidad de WhatsApp",
    derechos:
      "© 2026 AI Safety Colombia. Todos los derechos reservados. Bogotá, Colombia.",
  },
  en: {
    lema: "Working from Colombia towards safe artificial intelligence.",
    whatsapp: "Join us on WhatsApp",
    navegacion: "Navigation",
    comunidad: "Community",
    secciones: "Site sections",
    contacto: "Community and contact",
    whatsappRed: "WhatsApp community",
    derechos:
      "© 2026 AI Safety Colombia. All rights reserved. Bogotá, Colombia.",
  },
  pt: {
    lema: "Rumo a uma inteligência artificial segura, desde a Colômbia.",
    whatsapp: "Entre no WhatsApp",
    navegacion: "Navegação",
    comunidad: "Comunidade",
    secciones: "Seções do site",
    contacto: "Comunidade e contato",
    whatsappRed: "Comunidade no WhatsApp",
    derechos:
      "© 2026 AI Safety Colombia. Todos os direitos reservados. Bogotá, Colômbia.",
  },
};

/* La columna de comunidad: el correo y después las redes con su marca. */
const COMUNIDAD = [
  { href: "mailto:contacto@aisafetycolombia.org", label: "contacto@aisafetycolombia.org" },
];
...
export default function SiteFooter({ idioma = "es" }: { idioma?: Idioma }) {
  const t = TEXTOS[idioma];
  const navegacion = menu(idioma);
  return (
      ...
      <div className="mx-auto w-full max-w-[1400px] px-6 pt-16 pb-8 md:px-12 md:pt-20 lg:px-16">
        <div className="grid grid-cols-1 gap-10 md:gap-12 lg:grid-cols-[2fr_1fr_1fr]">
          ...
          <nav aria-label={t.contacto}>
            <h2 className={TITULO}>{t.comunidad}</h2>
            <ul className="mt-4 flex flex-col">
              {COMUNIDAD.map((l) => (
                <li key={l.label}>
                  <a
              ...
              {REDES.map((r) => (
                <li key={r.label}>
                  ...
                  >
                    ...
                    {r.label === "whatsapp" ? t.whatsappRed : r.label}
                  </a>
                </li>
              ))}
            </ul>
