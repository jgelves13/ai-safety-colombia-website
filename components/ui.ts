...
export const CTA_LINK = `${BUTTON_BASE} text-sash-frost hover:text-sash-frost/72 font-serif font-medium text-[1.375rem] md:text-[1.65rem]`;

/** the "Learn More" affordance inside program cards, which take their colour
    from the card rather than the panel */
export const CARD_LINK_FROST = `${BUTTON_BASE} text-display-4 md:text-display-4-lg text-sash-frost hover:text-sash-frost/72 mt-10 w-fit`;
export const CARD_LINK_COBALT = `${BUTTON_BASE} text-display-4 md:text-display-4-lg text-sash-cobalt hover:text-sash-midnight mt-10 w-fit`;

/** the hero band every interior page opens with */
export const PAGE_SHELL = "sash-page min-h-screen bg-white text-sash-graphite";
export const HERO_SECTION = "relative overflow-hidden bg-sash-midnight text-sash-frost";
...
export const CTA_PANEL =
  "relative flex min-h-[380px] items-center justify-center overflow-hidden rounded-[var(--radius)] bg-sash-midnight px-6 py-20 text-center text-sash-frost md:min-h-[420px] md:px-10 md:py-24 lg:min-h-[500px] lg:px-20 lg:py-28";
